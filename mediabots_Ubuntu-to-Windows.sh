...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://archive.org/download/WinServer2012R2Essentialsx64/en_windows_server_2012_r2_essentials_with_update_x64_dvd_6052824.iso 
